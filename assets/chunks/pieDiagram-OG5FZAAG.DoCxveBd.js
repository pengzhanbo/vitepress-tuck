import{t as e}from"./chunk-AQ6EADP3.CZhslHi-.js";import{W as t,c as n,p as r,q as i}from"./chunk-LIEV3EAG.B7FQiT-s.js";import{G as a,L as o,Q as s,R as c,T as l,V as u,X as d,f,j as p,k as m}from"./chunk-KEUXMURM.ye2Bzter.js";import{t as h}from"./chunk-Y3FQM624.DhAcCXDG.js";import{t as g}from"./chunk-JQRUD6KW.CxRdTa4A.js";import{j as _}from"./chunk-NV3KIAZN.tedu7z8k.js";import"./chunk-STOV2HOB.DDYizIrP.js";import{a as v,p as y}from"./chunk-ENMKPL7Y.C3yEs8Yo.js";var b=c.pie,x={sections:new Map,showData:!1,config:b},S=x.sections,C=x.showData,w=structuredClone(b),T={getConfig:e(()=>structuredClone(w),`getConfig`),clear:e(()=>{S=new Map,C=x.showData,s()},`clear`),setDiagramTitle:m,getDiagramTitle:p,setAccTitle:u,getAccTitle:l,setAccDescription:o,getAccDescription:a,addSection:e(({label:e,value:t})=>{if(t<0)throw Error(`"${e}" has invalid value: ${t}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);S.has(e)||(S.set(e,t),i.debug(`added new section: ${e}, with value: ${t}`))},`addSection`),getSections:e(()=>S,`getSections`),setShowData:e(e=>{C=e},`setShowData`),getShowData:e(()=>C,`getShowData`)},E=e((e,t)=>{g(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),D={parse:e(async e=>{let t=await _(`pie`,e);i.debug(t),E(t,T)},`parse`)},O=e(e=>`
  .pieCircle{

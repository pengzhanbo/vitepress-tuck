  ...
  themeConfig: {
    ...
    sidebar: {
      ...
      '/zh/plugins/': { base: '/zh/plugins/', items: [
        { text: '概述', link: 'intro' },
        { text: '语法扩展', collapsed: false, items: [
          { text: '缩写词', link: 'abbr' },
          { text: '内容注释', link: 'annotation' },
          { text: 'Mark', link: 'mark' },
          { text: '隐秘文本', link: 'plot' },
          { text: '图标', link: 'icons' },
          { text: 'Obsidian 兼容', link: 'obsidian' },
        ] },
        { text: '内容容器', collapsed: false, items: [
          { text: '步骤', link: 'steps' },
          { text: '字段', link: 'field' },
          { text: '折叠内容', link: 'collapse' },
        ] },
        { text: '图表', collapsed: false, items: [
          { text: 'Mermaid', link: 'mermaid' },
          { text: 'PlantUML', link: 'plantuml' },
        ] },
        { text: '代码增强', collapsed: false, items: [
          { text: '代码块折叠', link: 'code-collapse' },
        ...
        { text: '资源嵌入', collapsed: false, items: [
          { text: '视频', link: 'video' },
          { text: 'PDF', link: 'pdf' },
